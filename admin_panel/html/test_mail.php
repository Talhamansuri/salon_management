...
# Fetch all appointments and related service category information
                                            ...
                                            <td>
                                                <div class='dropdown'>
                                                    ...
                                                    <div class='dropdown-menu'>
                                                        ...
                                                        <a class='dropdown-item' href='test_mail.php?cid={$appointment['appointment_id']}'>
                                                      ...
                                                      <a class='dropdown-item' href='test_mail.php?rid={$appointment['appointment_id']}'><i class='mdi mdi-trash-can-outline me-1'></i> Reject</a>
                                                    </div>
                                                </div>
                                            </td>
