...
$old_pass_query= mysqli_query($connection,"select * from tbl_admin where admin_id= $id");
$old_pass_data = mysqli_fetch_array($old_pass_query);
$old_pass = $old_pass_data['password'];
